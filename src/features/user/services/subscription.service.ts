...
import { MobileNotificationService } from 'src/features/notification/services/mobile-notification.service';
import { Subscription, SubscriptionType } from '../schemas/subscription.schema';
import { User } from '../schemas/user.schema';
import { WebNotificationService } from './../../notification/services/web-notification.service';
            ...
            switch (subscription.type) {
                case SubscriptionType.Web:
                    this.webNotificationService
                        ...
                        .catch(e =>
                            this.logger.debug(`${subscription.type} ${e}`),
                        );
                    break;
